 ...
 * @Modified_By avishek.das @Last_On 16-Jul-2019 9:41:37 PM
 */
...
public class GlobalExceptionHandler {
	...
	@ExceptionHandler({ EmployeeRoleNotFoundException.class })
	public ResponseEntity<ErrorResponse> handleEmployeeRoleNotFoundException(EmployeeRoleNotFoundException e,
			HttpServletRequest request) {
