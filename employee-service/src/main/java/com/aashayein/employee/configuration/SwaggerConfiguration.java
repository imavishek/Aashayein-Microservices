...
public class SwaggerConfiguration extends WebMvcConfigurationSupport {
	...
	public Docket apiDocket() {
		return new Docket(DocumentationType.SWAGGER_2)
			.select().apis(RequestHandlerSelectors.basePackage("com.aashayein.employee.controller"))
	...
	private ApiInfo apiInfo() {
		return new ApiInfo(
			...
			"v1.0", 
			"Terms of service", 
			new Contact("Avishek Das", "https://github.com/imavishek", "aashayein@gmail.com"), null, null, Collections.emptyList());
	}
