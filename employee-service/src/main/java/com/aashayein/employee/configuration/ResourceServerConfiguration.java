 ...
 * @Modified_By avishek.das @Last_On 29-Jul-2019 7:03:53 PM
 */
	...
	public void configure(HttpSecurity http) throws Exception {
		http
			...
			.authorizeRequests()
				...
				.antMatchers("/EmployeeProfile/resetPassword/**").permitAll()
				.antMatchers("/EmployeeProfile/sendActivationLink/**").permitAll()
				.antMatchers("/EmployeeProfile/sendResetPasswordLink/**").permitAll()
